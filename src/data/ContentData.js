...
export const zSidebarMenu = [
    ...
    { name: '달카페이 회원부동산 찾기', link: '/around-realestate', level_list: [0, 5, 10, ...zManagerLevel] },
    { name: '결제카드등록 및 변경하기', link: '/card/change', level_list: [0, 5, ...zManagerLevel] },
    { name: '계약 및 결제내역', link: '/history/contract', level_list: [0, 5, 10, ...zManagerLevel] },
    { name: '고객정보조회', link: '/customer-info', level_list: [5, 10, ...zManagerLevel] },
    { name: '공지사항 및 문의하기', link: '/list/notice', level_list: [0, 5, 10, ...zManagerLevel] },
    { name: '내 정보 확인하기', link: '/mypage', level_list: [0, 5, 10, ...zManagerLevel] },
